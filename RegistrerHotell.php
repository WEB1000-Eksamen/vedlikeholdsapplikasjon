...
<form action="RegistrerBestilling.php">
  ...
  <form method="post" action="RegistrerRom.php" id="endreBookingSkjema" name="endreBookingSkjema">
        ...
        Hotell ID <br /> <input type="text" id="RomID" name="RomID" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()" /> <br/>
        ...
        Land ID <br />  <input type="text" id="HotellromID" name="HotellromID" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()"/> <br/>
