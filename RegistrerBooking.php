...
<form action="RegistrerBestilling.php">
  ...
  <form method="post" action="RegistrerRom.php" id="endreBookingSkjema" name="endreBookingSkjema">
        ...
        Booking ID <br /> <input type="text" id="RomID" name="RomID" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()" /> <br/>
        Til Dato <br /> <input type="text" id="Navn" name="Navn" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()"/> <br/>
        Fra Dato <br /> <input type="text" id="Navn" name="Navn" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()"/> <br/>
        Rom ID <br /> <input type="text" id="Navn" name="Navn" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()"/> <br/>
        HR ID <br /> <input type="text" id="Navn" name="Navn" required onFocus="fokus(this)" onBlur="mistetFokus(this)" onMouseOver="musInn(this)" onMouseOut="musUt()"/> <br/>
        Bestillinger ID <?php require_once("listeboks-bilde.php"); ?>  <br/>
